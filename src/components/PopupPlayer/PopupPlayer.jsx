...
const PopupPlayer = ({ isPlay, togglePlay }) => {
  return (
    <>
      {isPlay && (
        <div className="fixed z-[9999] top-0 left-0 w-full h-full bg-black/50 
          backdrop-blur-md ">
          <div className="absolute w-full sm:max-w-[600px] top-1/2 left-1/2 
            ...
            <div className="bg-white dark:bg-dark p-5 m-3 rounded-lg shadow-md">
              ...
              <div>
                <iframe
                  width="100%"
                  height="315"
                  src="https://www.youtube.com/embed/6s_MqzsPp88?si=ABsuAyFtdvssniVt"
